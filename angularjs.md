...
Scope is what separates controllers and directives that can communicate only via scope. Scope is created only thru directives. Angular uses scope-tree with `$rootScope` as root.
